                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Product Type List</span>
                                        ...
                                        <tbody>
                                            @foreach($ProductTypes as $type)
                                                <tr>
                                                    <td>{{ $type->type }}</td>
                                                    <td>
                                                        <a href="javascript:void(0)" id="{{ $type->id }}" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> Edit</a>
                                                        <a href="javascript:void(0)" id="{{ $type->id }}" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
    ...
    return {
        init: function () {
            ...
            $('#editabledatatable').on("click", 'a.delete', function (e) {
                ...
                $.ajax({
                   type: 'DELETE',
                   url: "{{  url('/api/v1/admin/product_type') }}"+"/"+id,
                   headers: {
            ...
            function saveRow(oTable, nRow, id) {
                ...
                if (id !== undefined) {
                       ...
                       $.ajax({
                           type: 'POST',
                           url: "{{  url('/api/v1/admin/product_type') }}",
                           data: {type: values},
                           headers: {
                                'Accept':'application/json',
                                'Authorization' : 'Bearer '+ "{{ Session::get('access_token') }}"
